...
image_path = str(Path.home() / "Downloads" / "dial_400.png")
...
seconds_hand_len = 110  
minutes_hand_len = 95   
hours_hand_len = 70     
seconds_hand = canvas.create_line(200, 200, 200 + seconds_hand_len, 200 + seconds_hand_len, width=2, fill='blue')
minutes_hand = canvas.create_line(200, 200, 200 + minutes_hand_len, 200 + minutes_hand_len, width=3, fill='skyblue')
hours_hand = canvas.create_line(200, 200, 200 + hours_hand_len, 200 + hours_hand_len, width=5, fill='red')
